...
const tripData: Record<string, TripCard> = {
  peniche: {
    image: "/Rectangle 8.png", price: 45,
    title: "Beaches and Caves of Peniche",
    description: "Discover the hidden beaches and caves of the stunning Peniche coastline and have unforgettable adventures!",
    link: "/boat-tours/peniche", location: "peniche",
    details: "<p>Discover the hidden beaches and caves of the stunning Peniche coastline and have unforgettable adventures!</p><p>Our boat tours take you along the dramatic cliffs and secluded coves that are only accessible by sea. Visit the famous Berlengas archipelago and its crystal-clear turquoise waters.</p><p>Tours depart from Peniche harbor and last approximately 3 hours. Snorkeling equipment is available on board.</p>",
    equipmentPrice: "€ 10.00",
  },
  sesimbra: {
    image: "/Rectangle 8.png", price: 42,
    title: "Beaches and Caves of Sesimbra",
    description: "Discover the hidden beaches and caves of the stunning Arrábida coastline in Sesimbra and have unforgettable adventures!",
    link: "/boat-tours/sesimbra", location: "sesimbra",
    details: "<p>Discover the hidden beaches and caves of the stunning Arrábida coastline in Sesimbra and have unforgettable adventures!</p><p>The Natural Park of Arrábida offers some of the most beautiful scenery in Portugal. Our boat tours explore hidden grottoes and pristine beaches inaccessible by land.</p>",
    equipmentPrice: "€ 10.00",
  },
  madeira: {
    image: "/Rectangle 8.png", price: 55,
    title: "Coastal Discovery — Madeira",
    description: "Explore Madeira's dramatic volcanic coastline, towering cliffs and hidden sea caves on an unforgettable boat tour.",
    link: "/boat-tours/madeira", location: "madeira",
    details: "<p>Explore Madeira's dramatic volcanic coastline, towering cliffs and hidden sea caves on an unforgettable boat tour.</p><p>The island's rugged northern coast is best explored by sea, with impressive lava formations and natural swimming pools.</p>",
    equipmentPrice: "€ 15.00",
  },
  "santa-maria": {
    image: "/Rectangle 8.png", price: 60,
    title: "Island Hopping — Santa Maria",
    description: "Explore the golden sandy beaches and crystal-clear waters surrounding Santa Maria in the Azores by boat.",
    link: "/boat-tours/santa-maria", location: "santa-maria",
    details: "<p>Explore the golden sandy beaches and crystal-clear waters surrounding Santa Maria in the Azores by boat.</p><p>Santa Maria is the sunniest island in the Azores and its southern coast has beautiful sandy beaches accessible only by sea.</p>",
    equipmentPrice: "€ 12.00",
  },
  faial: {
    image: "/Rectangle 8.png", price: 58,
    title: "Caldera Coastal Tour — Faial",
    description: "Circumnavigate the stunning island of Faial and witness the power of its volcanic history from the sea.",
    link: "/boat-tours/faial", location: "faial",
    details: "<p>Circumnavigate the stunning island of Faial and witness the power of its volcanic history from the sea.</p><p>See the dramatic lava fields of the 1957 eruption, sea stacks, and the famous Capelinhos Volcano from a unique ocean perspective.</p>",
    equipmentPrice: "€ 20.00",
  },
  "sao-vicente": {
    image: "/Rectangle 8.png", price: 48,
    title: "North Coast Adventure — São Vicente",
    description: "Discover the wild and breathtaking north coast of Madeira near São Vicente, with towering cliffs and hidden beaches.",
    link: "/boat-tours/sao-vicente", location: "sao-vicente",
    details: "<p>Discover the wild and breathtaking north coast of Madeira near São Vicente, with towering cliffs and hidden beaches.</p><p>The north coast of Madeira is characterised by dramatic scenery and powerful Atlantic swells.</p>",
    equipmentPrice: "€ 10.00",
  },
};
...
const BoatTours = () => {
  ...
  useEffect(() => {
    ...
    const detailsEl = document.getElementById("boat-trip-details");
              ...
              <div className="mb-12">
                ...
                <div className="mb-6">
                  <svg width="157" height="7" viewBox="0 0 157 7" fill="none">
                    <mask id="mask0_bt" maskUnits="userSpaceOnUse" x="0" y="0" width="157" height="7">
                ...
                <p className="max-w-xl text-[16px] font-light text-white lg:text-lg">
                  Discover the hidden beaches and caves of the stunning Arrábida coastline in Sesimbra and have unforgettable adventures!
                </p>
              </div>
            </div>
          </section>
