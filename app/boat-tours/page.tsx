...
const tripData: Record<string, TripCard> = {
  ...
  sesimbra: {
    ...
    link: "/boat-tours/sesimbra",
    location: "sesimbra",
    details:
      "<p>Discover the hidden beaches and caves of the stunning Arrábida coastline in Sesimbra and have unforgettable adventures!</p><p>The Natural Park of Arrábida offers some of the most beautiful scenery in Portugal. Our boat tours explore hidden grottoes and pristine beaches inaccessible by land.</p>",
    equipmentPrice: "€ 10.00",
  },
  madeira: {
    image: "/Rectangle 8.png",
    ...
    description:
      "Explore Madeira's dramatic volcanic coastline, towering cliffs and hidden sea caves on an unforgettable boat tour.",
    link: "/boat-tours/madeira",
    location: "madeira",
    details:
      "<p>Explore Madeira's dramatic volcanic coastline, towering cliffs and hidden sea caves on an unforgettable boat tour.</p><p>The island's rugged northern coast is best explored by sea, with impressive lava formations and natural swimming pools.</p>",
  ...
  "santa-maria": {
    ...
    description:
      "Explore the golden sandy beaches and crystal-clear waters surrounding Santa Maria in the Azores by boat.",
    link: "/boat-tours/santa-maria",
    location: "santa-maria",
    details:
      "<p>Explore the golden sandy beaches and crystal-clear waters surrounding Santa Maria in the Azores by boat.</p><p>Santa Maria is the sunniest island in the Azores and its southern coast has beautiful sandy beaches accessible only by sea.</p>",
  ...
  faial: {
    ...
    description:
      "Circumnavigate the stunning island of Faial and witness the power of its volcanic history from the sea.",
    link: "/boat-tours/faial",
    location: "faial",
    details:
      "<p>Circumnavigate the stunning island of Faial and witness the power of its volcanic history from the sea.</p><p>See the dramatic lava fields of the 1957 eruption, sea stacks, and the famous Capelinhos Volcano from a unique ocean perspective.</p>",
  ...
  "sao-vicente": {
    ...
    description:
      "Discover the wild and breathtaking north coast of Madeira near São Vicente, with towering cliffs and hidden beaches.",
    link: "/boat-tours/sao-vicente",
    location: "sao-vicente",
    details:
      "<p>Discover the wild and breathtaking north coast of Madeira near São Vicente, with towering cliffs and hidden beaches.</p><p>The north coast of Madeira is characterised by dramatic scenery and powerful Atlantic swells.</p>",
    equipmentPrice: "€ 10.00",
  },
};
            ...
            <div className="max-w-3xl">
              <div className="mb-12">
                ...
                <p className="max-w-xl text-[16px] font-light text-white lg:text-lg">
                  Discover the hidden beaches and caves of the stunning Arrábida
                  coastline in Sesimbra and have unforgettable adventures!
                </p>
              </div>
            </div>
          </section>
              ...
              <div className="w-full lg:w-[469px] bg-[#f1f1f1] rounded-3xl p-4 flex flex-col items-center justify-center gap-4">
                ...
                {card.equipmentPrice && (
                  <p className="font-medium text-[18px] leading-[1.4] text-black text-center">
                    ...
                    <span className="underline">{card.equipmentPrice}</span>
                  </p>
                )}
              </div>
            </div>
