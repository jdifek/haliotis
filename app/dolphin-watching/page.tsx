...
const tripData: Record<string, TripCard> = {
  ...
  sesimbra: {
    ...
    description:
      "Explore the pristine waters of Sesimbra and encounter dolphins in their natural environment.",
    link: "/dolphin-watching/sesimbra",
    location: "sesimbra",
    details:
      "<p>Explore the pristine waters of Sesimbra and encounter dolphins in their natural environment.</p><p>Sesimbra's sheltered bay provides perfect conditions for dolphin watching year-round.</p>",
    equipmentPrice: "€ 0.00",
  },
  madeira: {
    image: "/Rectangle 8.png",
    ...
    description:
      "Madeira's deep ocean waters are home to multiple dolphin species. Join us for an unforgettable marine adventure.",
    link: "/dolphin-watching/madeira",
    location: "madeira",
    details:
      "<p>Madeira's deep ocean waters are home to multiple dolphin species including bottlenose, common, and striped dolphins.</p><p>Join us for an unforgettable marine adventure with our experienced naturalist guides.</p>",
    equipmentPrice: "€ 0.00",
  },
  "santa-maria": {
    image: "/Rectangle 8.png",
    ...
    description:
      "Santa Maria in the Azores offers some of the best cetacean watching in the world.",
    link: "/dolphin-watching/santa-maria",
    location: "santa-maria",
    details:
      "<p>Santa Maria in the Azores offers some of the best cetacean watching in the world. Sperm whales and multiple dolphin species can be spotted here.</p>",
    equipmentPrice: "€ 0.00",
  },
  faial: {
    image: "/Rectangle 8.png",
    ...
    description:
      "Faial in the Azores is a paradise for dolphin lovers. Encounter several species in their natural Atlantic habitat.",
    link: "/dolphin-watching/faial",
    location: "faial",
    details:
      "<p>Faial in the Azores is a paradise for dolphin lovers. The deep waters surrounding the island attract several species including common, bottlenose and Risso's dolphins.</p>",
    equipmentPrice: "€ 0.00",
  },
  "sao-vicente": {
    image: "/Rectangle 8.png",
    ...
    description:
      "Discover the magic of dolphin watching in São Vicente, Madeira.",
    link: "/dolphin-watching/sao-vicente",
    location: "sao-vicente",
    details:
      "<p>Discover the magic of dolphin watching in São Vicente, Madeira. The northern coast of Madeira provides stunning scenery and rich marine life.</p>",
    equipmentPrice: "€ 0.00",
  },
};
            ...
            <div className="max-w-3xl">
              <div className="mb-12">
                ...
                <p className="max-w-xl text-[16px] font-light text-white lg:text-lg">
                  Get ready for the experience of a lifetime! You&rsquo;ll be
                  amazed by the beauty of dolphins in their natural habitat.
                </p>
              </div>
            </div>
          </section>
