...
import { HeroSection } from "@/components/Freedive/HeroSection";
import { ArticleCard } from "@/components/ArticleCard";
import { Pagination } from "@/components/Pagination";
import { LOCATION_COLORS, Tabs } from "@/components/buttons/Tabs";
...
const generateCards = (location: string, count: number): TripCard[] => {
  ...
  return Array.from({ length: count }, (_, i) => ({
    ...
    description: `Amazing ${names[
      i % names.length
    ].toLowerCase()} in ${location}. Explore the best dive spots with our certified PADI instructors.`,
    ...
    <main className="-mt-[97px]">
      ...
      <div className="md:hidden bg-white px-4 py-3">
        <button
          ...
          style={{ borderColor: LOCATION_COLORS[activeTab] ?? "#e84814" }}
        >
                    ...
                    style={
                      isSelected
                        ? {
                            ...
                            borderColor: LOCATION_COLORS[tab.id] ?? "#e84814",
                          }
