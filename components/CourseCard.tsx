...
import { AddToCartButton, CartItemType } from "./buttons/AddToCartButton";
...
type CourseCardProps = {
  id: number;
  itemType?: CartItemType; // "course" | "trip" — по умолчанию "course"
  image: string;
  title: string;
  price: number;
  purchaseLink?: string;
...
{!buyNow && (
        ...
        <div className="mt-2 sm:mt-3 h-[220px] md:h-[165px] rounded-2xl bg-[#f1f1f1] p-2 sm:p-3 flex flex-col justify-between">
          ...
          <div className="flex items-center flex-col md:flex-row justify-between gap-3 items-start md:items-center">
            <div className="flex items-center gap-2 rounded-lg bg-white px-2 md:px-3 py-1 md:py-3">
              <svg
                width="20"
                height="20"
                viewBox="0 0 20 20"
            ...
            >
              <span className="text-[15px] font-bold leading-[120%] text-white">
                {buyNow ? menu.terms.buy_now : menu.terms.book_now}
              </span>
