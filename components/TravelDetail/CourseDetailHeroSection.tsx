...
const AddToCartButton = ({
  ...
  <button
    ...
    className={`flex items-center whitespace-nowrap cursor-pointer gap-2 rounded-full py-0.5 pl-[14px] pr-[14px] md:pl-4 md:pr-4 h-[44px] text-[15px] font-bold leading-[120%] text-white transition-all
      ${
        added
          ? "bg-[#22a35a] hover:bg-[#1a8f4a]"
          : "bg-[#281d4d] hover:bg-[#1a1235]"
      }`}
  >
    {added ? (
      <>
...
/>                <BookNowButton onClick={onBookClick} />
        ...
        {/* ── DIVIDER ── */}
        <div className="h-px bg-[#e4e4e4] -mx-4 md:-mx-8 lg:-mx-[188px] my-6 md:my-10" />
          ...
          {accordionItems.map((item, index) => (
            <div key={item.id}>
              ...
              <div className="md:hidden">
                ...
                >
                  <span className="text-[18px] font-medium leading-[140%] text-[#111]">
                    {item.label}
                  </span>
