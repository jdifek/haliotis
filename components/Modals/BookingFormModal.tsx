    ...
    <div className="relative">
      <button
        ...
        className={`flex items-center justify-between gap-2 ${
          icon ? "pl-8" : "pl-3"
        } pr-3 py-2 rounded-[10px] border border-[#d9d9d9] bg-white text-[15px] text-[#111] leading-[140%] w-full outline-none focus:border-[#e84814] transition-colors cursor-pointer ${
          !value ? "text-[#111]" : ""
        }`}
      >
        {icon && (
