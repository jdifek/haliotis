...
export const TripsSection: React.FC<Props> = ({
  ...
  const [isTripsSwiperLocked, setIsTripsSwiperLocked] = useState(false);
      ...
      <div className="flex flex-col lg:flex-row">
        ...
        <div className="flex flex-1 flex-col gap-[30px] overflow-hidden">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            ...
            {!isTripsSwiperLocked && filteredTrips.length > 0 && (
                <CarouselControls
          ...
          <div className="w-full">
            <Swiper
              ...
              onSwiper={(swiper) => {
                ...
                setIsTripsSwiperLocked(swiper.isLocked);
              }}
              ...
              breakpoints={{
                393: { slidesPerView: 1, spaceBetween: 20 },
                640: { slidesPerView: 1, spaceBetween: 20 },
                768: { slidesPerView: 1, spaceBetween: 25 },
                1400: { slidesPerView: 2, spaceBetween: 30 },
                1904: { slidesPerView: 2, spaceBetween: 30 },
                1905: { slidesPerView: 3, spaceBetween: 30 },
              }}
            >
